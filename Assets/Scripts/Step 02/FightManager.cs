...
namespace MaxValentine
{
    ...
    {
        public Color drawCol = Color.green; // A colour you might want to set the battle log message to if it's a draw.
        ...
        private Color teamAColour = Color.magenta; // stores the current team colour, if there is no team then it will defeault to red for A, and Blue for B
        private Color teamBColour =Color.cyan;
