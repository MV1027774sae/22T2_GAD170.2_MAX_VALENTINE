    ...
    public class BattleSystem : MonoBehaviour
    {
        ...
        IEnumerator DoRound()
        {
            ...
            else if (teamA.activeDancers.Count > 0 && teamB.activeDancers.Count > 0)
            {
                ...
                Character teamAcharacter = Random.Range[0, teamAcharacter]; // instead of null (nothing) we probably want a random charcter from each team.
                Character teamBCharacter = Random.Range[0, teamBCharacter];
